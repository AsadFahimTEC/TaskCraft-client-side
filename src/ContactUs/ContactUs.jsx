const ContactUs = () => {
  return (
    <div>
      <div>
        <div className="mt-10 relative bg-red-600 hover:bg-green-600">
          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="relative max-w-2xl sm:mx-auto sm:max-w-xl md:max-w-2xl sm:text-center">
              ...
              <p className="mb-6 font-semibold text-black md:text-lg">
                Stay in the loop and never miss a bite! Subscribe to our
                newsletter for the latest updates, exclusive offers, and
                mouthwatering news on the world of food and beverages. Join our
                community of food enthusiasts today.
              </p>
              ...
              <p className="max-w-md mb-10 text-xs tracking-wide text-indigo-100 sm:text-sm sm:mx-auto md:mb-16">
                Our Subscribe to Our Newsletter section is designed with your
                interests in mind.
              </p>
              <a
                href="/"
